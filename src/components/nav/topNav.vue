  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-logos">
        <a href="/" style="color: #fff;"><span>天津市恒润环境工程有限公司-在线监控平台</span></a>
      </div>
        ...
        <el-row>
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              ...
              <el-menu-item index="/work-process">工作流程</el-menu-item>
              <el-menu-item index="/fileManger">文件管理</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>       
      </div>
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item>
              <div @click="jumpTo('/denglu')"><span style="color: #555;font-size: 14px;">修改密码</span></div>
            </el-dropdown-item>

  ...
  <div class="warp-main">
    <el-row :span="24" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table ref="multipleTable" :data="tableData"  border style="width: 100%;" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="eName" label="建设单位" show-overflow-tooltip></el-table-column>
        <el-table-column prop="eIndustry" label="项目名称" show-overflow-tooltip ></el-table-column>
        <el-table-column prop="eRange" label="项目地点" show-overflow-tooltip ></el-table-column>
        <el-table-column prop="eModel" label="合同编号" width="120"></el-table-column>
        <el-table-column prop="createTime" label="项目进度" width="120"></el-table-column>
        <el-table-column prop="updateTime" label="安装数量" width="120"></el-table-column>
        <el-table-column prop="recordStatus" label="回款情况" width="120"></el-table-column>

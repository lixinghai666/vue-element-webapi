...
import Workprocess from '@/views/work-process/main.vue'
import FileManger from '@/views/file/measure.vue'
import Report from '@/views/file/report.vue'
import Delete from '@/components/sqlhelper/delete.vue'
...
let router = new Router({
  routes: [
    ...
    },
    {
      ...
      name: 'work-process',
      component: Home,
      redirect: '/work-process/main',
      menuShow: true,
      children: [
        {
          path: '/work-process/main',
          name: '监测数据展示',
          components: {
            default: Workprocess,
            top: TopNav,
